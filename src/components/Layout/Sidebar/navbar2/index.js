    ...
    <div className="relative overflow-x-auto scroll-container w-full h-full">
      <div className="absolute top-0 left-0 right-0">
        <div className="relative mb-4">
          ...
          <div className="hidden lg:inline-block px-2 py-4 rounded-lg mx-5 text-center bg-gradient-to-r from-[#5a4be7] to-[#c86dd7]">
            <div className="text-sm mb-2 font-semibold">
              Nghe nhạc không quảng cáo cùng kho nhạc PREMIUM
            </div>
            <a
              className="bg-[#ffdb00] border rounded-full border-[#ffdb00] text-black inline-block px-4 py-1 text-sm font-semibold"
              href="https://zingmp3.vn/vip/upgrade?src_vip=115"
            >
              Nâng cấp tài khoản
            </a>
          </div>
