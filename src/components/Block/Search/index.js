...
function SearchInput() {
  return (
    <div className="relative text-gray-600">
      <input type="search" name="search" placeholder="Nhập vào tên ca sĩ, bài hát, album" className="bg-[#1b2639] h-10 px-5 w-[300px] pr-10 text-white rounded-full text-sm focus:outline-none" />
