...
function SearchInput() {
  return (
    <div className="hidden md:inline-block relative w-full max-w-[300px] text-gray-600">
      <input type="search" name="search" placeholder="Nhập vào tên ca sĩ, bài hát, album" className="bg-[#1b2639] h-10 px-5 w-full pr-10 text-white rounded-full text-sm focus:outline-none" />
